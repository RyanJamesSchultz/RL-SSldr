...
agentOptions.ExplorationModel.StandardDeviation = [0.0;0.10];
agentOptions.ExplorationModel.StandardDeviationDecayRate = [0;1e-6];
agentOptions.ExplorationModel.StandardDeviationMin = [0;0.10];
agentOptions.TargetPolicySmoothModel.StandardDeviation = [0.0;0.05];
agentOptions.TargetPolicySmoothModel.StandardDeviationDecayRate = [0;1e-6];
agentOptions.TargetPolicySmoothModel.StandardDeviationMin = [0;0.05];
...
agent.AgentOptions.ExplorationModel.StandardDeviation = [0.0;0.10];
...
agent.AgentOptions.TargetPolicySmoothModel.StandardDeviation = [0.0;0.05];
...
trainingStats = train(agent,SS1env,trainingStats);
SS1env.reset();
save('initialAgent_p2_6e5.mat','agent','trainingStats','SS1env');
...
trainingStats = train(agent,SS1env,trainingStats);
SS1env.reset();
save('initialAgent_p2_8e5.mat','agent','trainingStats','SS1env');

% Train for 2i.
trainingStats.TrainingOptions.MaxEpisodes=9e5;
trainingStats = train(agent,SS1env,trainingStats);
SS1env.reset();
save('initialAgent_p2_9e5.mat','agent','trainingStats','SS1env');
...
agent.AgentOptions.TargetPolicySmoothModel.StandardDeviation = [0.0;0.02];
agent.AgentOptions.TargetPolicySmoothModel.StandardDeviationDecayRate = [0;3e-4];
agent.AgentOptions.TargetPolicySmoothModel.StandardDeviationMin = [0;0.01];
...
% Train for 3f.
trainingStats.TrainingOptions.MaxEpisodes=1.6e6;
trainingStats = train(agent,SS1env,trainingStats);
SS1env.reset();
save('initialAgent_p3_6e5.mat','agent','trainingStats','SS1env');

% Train for 3g.
trainingStats.TrainingOptions.MaxEpisodes=1.7e6;
trainingStats = train(agent,SS1env,trainingStats);
SS1env.reset();
save('initialAgent_p3_7e5.mat','agent','trainingStats','SS1env');

% Train for 3h.
trainingStats.TrainingOptions.MaxEpisodes=1.8e6;
trainingStats = train(agent,SS1env,trainingStats);
SS1env.reset();
save('initialAgent_p3_8e5.mat','agent','trainingStats','SS1env');

% Train for 3i.
trainingStats.TrainingOptions.MaxEpisodes=1.9e6;
trainingStats = train(agent,SS1env,trainingStats);
SS1env.reset();
save('initialAgent_p3_9e5.mat','agent','trainingStats','SS1env');

% Train for 3j.
trainingStats.TrainingOptions.MaxEpisodes=2e6;
trainingStats = train(agent,SS1env,trainingStats);
SS1env.reset();
