...
% Create the spring slider enviroment.
SS1env = RL_SSenv();
...
agentOptions.ExplorationModel.StandardDeviationDecayRate = [0;1e-5];
agentOptions.ExplorationModel.StandardDeviationMin = [0;1e-2];
agentOpts.TargetPolicySmoothModel.StandardDeviation = [0.0;0.10];        % Oops :(
agentOpts.TargetPolicySmoothModel.StandardDeviationDecayRate = [0;1e-5]; % Oops :(
