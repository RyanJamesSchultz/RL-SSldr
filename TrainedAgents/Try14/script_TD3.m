...
agentOptions.ExplorationModel.StandardDeviationMin = [0;0.02];
...
agentOptions.TargetPolicySmoothModel.StandardDeviationMin = [0;0.02];
...
trainingOpts.MaxEpisodes=4e5;
agent.AgentOptions.ExplorationModel.StandardDeviation = [0.0;0.02];
agent.AgentOptions.ExplorationModel.StandardDeviationDecayRate = [0;5e-5];
agent.AgentOptions.ExplorationModel.StandardDeviationMin = [0;0.015];
agent.AgentOptions.TargetPolicySmoothModel.StandardDeviation = [0.0;0.02];
agent.AgentOptions.TargetPolicySmoothModel.StandardDeviationDecayRate = [0;5e-5];
