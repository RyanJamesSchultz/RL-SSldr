...
trainingOpts = rlTrainingOptions('MaxEpisodes',maxepisodes,...
    ...
    'ScoreAveragingWindowLength',1e3,...
...
trainingStats.TrainingOptions.MaxEpisodes=1.5e5;
...
trainingStats.TrainingOptions.MaxEpisodes=2.5e5;
...
% Train for 2c.
trainingStats.TrainingOptions.MaxEpisodes=3.5e5;
trainingStats = train(agent,SS1env,trainingStats);
SS1env.reset();
...
% Save again.
SS1env.reset();
save('initialAgent_p3_05e4.mat','agent','trainingStats','SS1env');
